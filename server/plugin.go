...
// isCloudflareBackend returns whether the Cloudflare Calls backend is being used.
// If both rtcServer and rtcdManager are nil, the Cloudflare backend is selected.
